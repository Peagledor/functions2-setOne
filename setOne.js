...
const findGrape2 = function(arr){
    for(let i = 0; i < arr.length; i++){
        if(arr[i.color === "purple"]){
            return console.log(`The fruit with index ${arr.indexOf(arr[i])} os a grape`)
        }
    }
}
...
////////// PROBLEM 2 //////////
/*
Write a one line function (give a name of your choice) with an implicit return that when 
the function is invoked, it will print: 'The first parameter is [parameter1]. 
